...
declare namespace Paths {
  ...
  namespace CreateOrder {
    export type RequestBody =
      /* Parameters for an order, including a signature. */ Components.Schemas.OrderRequest;
    namespace Responses {
      export type $200 = string;
      export interface $400 {}
      export interface $500 {}
  ...
  namespace GetActiveOrdersByAddress {
    namespace Responses {
      export type $200 =
        /* Details of an existing order. */ Components.Schemas.Order[];
      export interface $500 {}
    }
  }
  namespace GetNonce {
  ...
  namespace RefreshAuth {
    ...
    namespace Responses {
      export type $200 =
        /* A JSON object containing two string fields, access_token and refresh_token. */ Components.Schemas.JWTPair;
      export interface $400 {}
      export interface $500 {}
    }
  }
  namespace SignIn {
    export type RequestBody =
      /* A JSON object containing two string fields, a Sign in With Ethereum message and signature. The nonce found in the decoded signature should match the nonce in the message. */ Components.Schemas.SigninData;
    namespace Responses {
      export type $200 =
        /* A JSON object containing two string fields, access_token and refresh_token. */ Components.Schemas.JWTPair;
      export interface $400 {}
...
export interface OperationMethods {
  ...
  "estimateFee"(
    parameters?: Parameters<
      Paths.FeesEstimate$MarketId.PathParameters &
        Paths.FeesEstimate$MarketId.HeaderParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig
  ...
  "cancelOrderByDigest"(
    parameters?: Parameters<
      Paths.OrdersAddress$AddressOrder$DigestCancel.PathParameters &
        Paths.OrdersAddress$AddressOrder$DigestCancel.HeaderParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig
  ...
  "cancelOrder"(
    parameters?: Parameters<
      Paths.OrdersAddress$AddressMarket$MarketIdCancel.PathParameters &
        Paths.OrdersAddress$AddressMarket$MarketIdCancel.HeaderParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig
  ...
  "getOrdersByAddress"(
    parameters?: Parameters<
      Paths.OrdersAddress$Address.PathParameters &
        Paths.OrdersAddress$Address.HeaderParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig
  ...
  "getActiveOrdersByAddress"(
    parameters?: Parameters<
      Paths.OrdersAddress$AddressActive.PathParameters &
        Paths.OrdersAddress$AddressActive.HeaderParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig
  ...
  "isTokenSupported"(
    parameters?: Parameters<
      Paths.QuoteTokens$TokenAddress.PathParameters &
        Paths.QuoteTokens$TokenAddress.HeaderParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig
