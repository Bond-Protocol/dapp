...
export const getSubgraphQueries = (query: ({}: any, {}: any, {}: any) => UseQueryResult<any, any>, variables?:{}): UseQueryResult<any, any>[] => {
...
export const getSubgraphEndpoints2 = (): { url: string, chain: CHAIN_ID }[] => {
  ...
  if (testnet) {
    return [
      { url: subgraphEndpoints[CHAIN_ID.GOERLI_TESTNET], chain: CHAIN_ID.GOERLI_TESTNET },
      { url: subgraphEndpoints[CHAIN_ID.ARBITRUM_GOERLI_TESTNET], chain: CHAIN_ID.ARBITRUM_GOERLI_TESTNET },
    ]
  }

  return [
    { url: "https://api.thegraph.com/subgraphs/name/spaceturtleship/bp-arbitrum-testing", chain: CHAIN_ID.ARBITRUM_MAINNET },
    { url: "https://api.thegraph.com/subgraphs/name/spaceturtleship/bp-ethereum-testing", chain: CHAIN_ID.ETHEREUM_MAINNET },
    // subgraphEndpoints[CHAIN_ID.ARBITRUM_MAINNET],
  ];
};

export const getSubgraphQueriesPerChainFn = (query: ({}: any, {}: any, {}: any) => UseQueryResult<any, any>, func: (chain: CHAIN_ID) => any, fieldName: string): UseQueryResult<any, any>[] => {
