export const terms = {
  ...
  welcome: (
    <>
      <p>
        ...
        agree, you are not authorized to access or use the Site and should not
        use the Site.
      </p>
  ...
  conditions: [
    {
      title: "1. Modification of these Terms",
      content:
        "Bond reserves the right, in its sole discretion, to modify these Terms from time to time. If any modifications are made, we will notify you by updating the date at the top of the Terms. A current version of the Terms is maintained at https://app.bondprotocol.finance/terms. All modifications will be effective when they are posted, and your continued accessing of the Site will serve as confirmation of your acceptance of those modifications. If you do not agree with any modifications to these Terms, you must immediately stop accessing the Site.",
    },
    {
      title: "2 .Eligibility",
      content: (
        <>
          <p>
            ...
            and conditions of these Terms on behalf of yourself and any company
            or legal entity for which you may access or use the Site.
          </p>
          <p className="mt-4">
      ...
      content: (
        <>
          <p>
            ...
            your blockchain wallet address and your transaction send
            information. We do not collect any personal information from you
            (e.g., your name or other identifiers that can be linked to you).
            Please see the Privacy Policy for further information.
          </p>

          <p className="mt-4">
            When you use the Site, you are interacting with the public
            blockchains, which provide transparency into your transactions. Bond
            does not control and is not responsible for any information you make
            public on any public blockchain by taking actions through the Site.
          </p>

          <p className="mt-4">
            Bond may share the information collected with blockchain analytics
            providers to promote the safety, security, and integrity of the
            Site. Bond does not retain any information collected any longer than
    ...
    {
      title: "7. Not Registered with FinCEN or any agency",
      content:
        "Bond is not registered with the Financial Crimes Enforcement Network as a money services business or in any other capacity. You understand and acknowledge that we do not broker trading orders on your behalf, match orders for buyers and sellers of securities. We also do not facilitate the execution or settlement of your trades, which occur entirely on the public distributed blockchains.",
    },
    {
      title: "8. Non-Solicitation; No Investment Advice",
      content: (
        <>
          <p>
            You agree and understand that all transfers, pools, farming, staking
            or other actions you perform through the Site are considered
            unsolicited, which means that you have not received any investment
            advice from us in connection with any such action, and that we do
            not conduct a suitability review of any action available to you via
            the Site.
          </p>
          <p className="mt-4">
            All information provided by the Site is for informational purposes
            only and should not be construed as investment advice. You should
            not take, or refrain from taking, any action based on any
            information contained in the Site. We do not make any investment
    ...
    {
      title: "10. Non-Custodial and No Fiduciary Duties",
      content:
    ...
    {
      title: "11. Compliance Obligations",
      content:
      ...
      content: (
        <>
          <p>
            ...
            the usage and intricacies of digital assets. You understand that
          ...
          <p className="mt-4">
            ...
            accept the risk that your digital assets may lose some or all of
            their value while they are supplied to the Protocol through the
            Site, you may suffer loss due to the fluctuation of prices of tokens
            in a trading pair or liquidity pool, and, especially in expert
            modes, experience significant price slippage and cost. You
            ...
            we are not responsible for any of these variables or risks, do not
            ...
            Site. Accordingly, you understand and agree to assume full
            responsibility for all of the risks of accessing and using the Site
    ...
    {
      title: "13. Third-Party Resources and Promotions",
      content:
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            Bond will use our best efforts to resolve any potential disputes
    ...
    },
    {
      ...
      content:
        "You agree that the laws of the British Virgin Islands, without regard to principles of conflict of laws, govern these Terms and any Dispute between you and us. You further agree that the Site shall be deemed to be based solely in the British Virgin Islands, and that although the Site may be available in other jurisdictions, its availability does not give rise to general or specific personal jurisdiction in any forum outside the British Virgin Islands. Any arbitration conducted pursuant to these Terms shall be governed by the British Virgin Islands Arbitration Act or 2013. You agree that the courts of the British Virgin Islands are the proper forum for any appeals of an arbitration award or for court proceedings in the event that the binding arbitration clause of these Terms is found to be unenforceable.",
    },
    {
      title: "20. Entire Agreement",
      content:
        "These Terms, the Privacy Policy, and Cookie Policy constitute the entire agreement between you and us with respect to the subject matter hereof. These Terms supersede any and all prior or contemporaneous written and oral agreements, communications and other understandings (if any) relating to the subject matter of the terms. The information provided on the Site is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Site from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.",
    },
  ],
};
