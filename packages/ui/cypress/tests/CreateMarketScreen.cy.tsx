...
describe("<CreateMarketScreen />", () => {
  it.only("Creates a dynamic discount market", () => {
    cy.spy(defaultProps, "onSubmitCreation").as("onSubmitSpy");

    component.mount(defaultProps);
    ...
    //cy.get("@onSubmitSpy").should("have.been.calledWith", args);
  });
});
...
const args = [
  {
    ...
    oracle: false,
    endDate: "2023-04-19T08:44:19.373Z",
  },
];
