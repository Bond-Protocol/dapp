...
import type { DodoLp, DodoLpInterface } from "../DodoLp";
...
export class DodoLp__factory {
  static readonly abi = _abi;
  static createInterface(): DodoLpInterface {
    return new utils.Interface(_abi) as DodoLpInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): DodoLp {
    return new Contract(address, _abi, signerOrProvider) as DodoLp;
  }
}
